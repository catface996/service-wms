package com.catface.wms.repository.generator;
...
import com.catface.wms.BaseTest;
...
public class GeneratorServiceEntity extends BaseTest {
    ...
    private final String packageName = "com.catface.wms.repository";
    ...
    public void generateAllCode() {
        generateByTables(serviceNameStartWithI, packageName, "floor");
    }

    @Test
    public void generateOnlyEntity() {
        generateEntity(serviceNameStartWithI, packageName, "warehouse");
    }
